...
-- Extracted from: F:\github\GreenStack\greenstack.db
-- Total tables: 70
================================================================================
...
CREATE INDEX idx_cdri_sv_record_item_id ON custom_datatype_record_item_single_values (record_item_id);
...
CREATE INDEX idx_custom_datatype_record_items_datatype_id ON custom_datatype_record_items (datatype_id);
...
CREATE INDEX idx_custom_datatype_single_values_datatype_id ON custom_datatype_single_values (datatype_id);
...
CREATE INDEX idx_custom_datatypes_device_id ON custom_datatypes (device_id);
CREATE INDEX idx_custom_datatypes_datatype_id ON custom_datatypes (datatype_id);
...
CREATE INDEX idx_device_test_config_device_id ON device_test_config (device_id);
...
CREATE INDEX idx_device_test_event_triggers_test_config_id ON device_test_event_triggers (test_config_id);
...
CREATE INDEX idx_device_variants_product_id ON device_variants (product_id);
...
CREATE INDEX idx_eds_assemblies_number ON eds_assemblies (assembly_number);
CREATE INDEX idx_eds_assemblies_assembly_number ON eds_assemblies(assembly_number);
CREATE INDEX idx_eds_assemblies_assembly_name ON eds_assemblies(assembly_name);
...
CREATE INDEX ix_eds_capacity_eds_file_id ON eds_capacity (eds_file_id);
CREATE INDEX idx_eds_capacity_eds_file_id ON eds_capacity(eds_file_id);
...
CREATE INDEX ix_eds_connections_eds_file_id ON eds_connections (eds_file_id);
CREATE INDEX idx_eds_connections_eds_file_id ON eds_connections(eds_file_id);
CREATE INDEX idx_eds_connections_connection_number ON eds_connections(connection_number);
...
CREATE INDEX idx_dlr_file ON eds_dlr_config (file_id);
...
CREATE INDEX idx_ethernet_file ON eds_ethernet_link (file_id);
...
CREATE UNIQUE INDEX idx_file_meta ON eds_file_metadata (file_id);
...
CREATE INDEX ix_eds_files_vendor_code ON eds_files (vendor_code);
CREATE INDEX ix_eds_files_product_code ON eds_files (product_code);
CREATE INDEX ix_eds_files_vendor_name ON eds_files (vendor_name);
CREATE INDEX ix_eds_files_package_id ON eds_files (package_id);
CREATE INDEX ix_eds_files_variant_type ON eds_files (variant_type);
CREATE INDEX ix_eds_files_is_latest_version ON eds_files (is_latest_version);
...
CREATE INDEX idx_eds_groups_eds_file_id ON eds_groups (eds_file_id);
...
CREATE INDEX idx_lldp_file ON eds_lldp_management (file_id);
...
CREATE INDEX idx_obj_meta_file ON eds_object_metadata (file_id);
CREATE INDEX idx_obj_meta_section ON eds_object_metadata (section_name);
...
CREATE INDEX ix_eds_package_metadata_package_id ON eds_package_metadata (package_id);
...
CREATE INDEX ix_eds_packages_package_name ON eds_packages (package_name);
...
CREATE INDEX ix_eds_parameters_eds_file_id ON eds_parameters (eds_file_id);
...
CREATE INDEX idx_eds_parameters_data_type ON eds_parameters(data_type);
...
CREATE INDEX ix_eds_ports_eds_file_id ON eds_ports (eds_file_id);
CREATE INDEX idx_eds_ports_eds_file_id ON eds_ports(eds_file_id);
...
CREATE INDEX idx_qos_file ON eds_qos_config (file_id);
...
CREATE INDEX idx_tcpip_file ON eds_tcpip_interface (file_id);
...
CREATE INDEX ix_eds_tspecs_eds_file_id ON eds_tspecs (eds_file_id);
...
CREATE INDEX idx_eds_variable_assemblies_eds_file_id ON eds_variable_assemblies (eds_file_id);
CREATE INDEX idx_eds_variable_assemblies_number ON eds_variable_assemblies (assembly_number);
...
CREATE INDEX ix_iodd_assets_device_id ON iodd_assets (device_id);
CREATE INDEX ix_iodd_assets_file_type ON iodd_assets (file_type);
CREATE INDEX ix_iodd_assets_image_purpose ON iodd_assets (image_purpose);
...
CREATE INDEX ix_iodd_build_format_device_id ON iodd_build_format (device_id);
...
CREATE INDEX idx_iodd_files_device_id ON iodd_files(device_id);
CREATE INDEX ix_iodd_files_device_id
...
CREATE INDEX idx_iodd_text_device_language ON iodd_text (device_id, language_code);
CREATE INDEX idx_iodd_text_text_id ON iodd_text (text_id);
CREATE INDEX idx_iodd_text_device_id ON iodd_text (device_id);
...
CREATE INDEX ix_parameter_record_items_parameter_id ON parameter_record_items (parameter_id);
...
CREATE INDEX ix_parameter_single_values_parameter_id ON parameter_single_values (parameter_id);
...
CREATE INDEX idx_pqa_queue_status ON pqa_analysis_queue (status);
CREATE INDEX idx_pqa_queue_priority ON pqa_analysis_queue (priority);
CREATE INDEX idx_pqa_queue_device ON pqa_analysis_queue (device_id);
...
CREATE INDEX idx_pqa_diff_metric ON pqa_diff_details (metric_id);
CREATE INDEX idx_pqa_diff_severity ON pqa_diff_details (severity);
CREATE INDEX idx_pqa_diff_type ON pqa_diff_details (diff_type);
CREATE INDEX idx_pqa_diff_phase ON pqa_diff_details (phase);
...
CREATE INDEX idx_pqa_archive_timestamp ON pqa_file_archive (upload_timestamp);
...
CREATE INDEX idx_pqa_metrics_device ON pqa_quality_metrics (device_id);
CREATE INDEX idx_pqa_metrics_archive ON pqa_quality_metrics (archive_id);
CREATE INDEX idx_pqa_metrics_timestamp ON pqa_quality_metrics (analysis_timestamp);
CREATE INDEX idx_pqa_metrics_score ON pqa_quality_metrics (overall_score);
CREATE INDEX idx_pqa_metrics_passed ON pqa_quality_metrics (passed_threshold);
...
CREATE INDEX idx_pqa_threshold_active ON pqa_thresholds (active);
...
CREATE INDEX idx_process_data_conditions_process_data_id ON process_data_conditions (process_data_id);
CREATE INDEX idx_process_data_conditions_variable_id ON process_data_conditions (condition_variable_id);
...
CREATE INDEX idx_process_data_ui_info_process_data_id ON process_data_ui_info (process_data_id);
...
CREATE INDEX ix_ri_sv_record_item_id ON record_item_single_values (record_item_id);
...
CREATE INDEX ix_std_var_ref_sv_ref_id ON std_variable_ref_single_values (std_variable_ref_id);
...
CREATE INDEX ix_std_variable_refs_device_id ON std_variable_refs (device_id);
...
CREATE INDEX idx_ui_menu_buttons_menu_item_id ON ui_menu_buttons (menu_item_id);
...
CREATE INDEX ix_variable_record_item_info_parameter_id ON variable_record_item_info (parameter_id);
...
CREATE INDEX idx_wire_configurations_device_id ON wire_configurations (device_id);
