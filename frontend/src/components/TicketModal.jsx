        ...
        <div className="px-6 py-4 bg-slate-800/50 border-b border-slate-800">
          <div className="grid grid-cols-3 gap-4 text-sm">
            <div>
              ...
              <span className="ml-2 text-white font-medium">{deviceType}</span>
            </div>
            {vendorName && (
              <div>
                <span className="text-slate-500">Vendor:</span>
                <span className="ml-2 text-white font-medium">{vendorName}</span>
              </div>
            )}
            {productCode && (
              <div>
                <span className="text-slate-500">Product Code:</span>
                <span className="ml-2 text-white font-medium">{productCode}</span>
              </div>
            )}
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
              >
          ...
          <div className="flex justify-end gap-3 pt-4">
            <button
              ...
              className="px-6 py-2 border border-slate-700 text-slate-300 rounded-lg hover:bg-slate-800 transition-colors disabled:opacity-50"
            >
              Cancel
            </button>
            <button
              ...
              className="px-6 py-2 bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
