  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center p-8">
        ...
        <span className="ml-2 text-slate-400">Loading assemblies...</span>
      </div>
    );
  }
        ...
        <div>
          ...
          <div className="grid gap-4">
            {assemblies.fixed.map((assembly) => (
              <Card
                key={assembly.id}
                className="bg-slate-900 border-slate-800 hover:border-green-700/50 transition-colors"
              >
                <CardHeader>
                ...
                <CardContent className="space-y-3">
                  <div className="grid grid-cols-3 gap-4 text-sm">
                    ...
                    <div>
                      <div className="text-xs text-slate-500 mb-1">Field 1</div>
                      ...
                      <div className="space-y-1">
                        {assembly.used_by_connections.map((conn, idx) => (
                          <div key={idx} className="flex items-center gap-2 text-xs">
                            ...
                            <span className="text-slate-300">{conn.connection_name || `Connection ${conn.connection_number}`}</span>
              ...
              >
                ...
                <CardContent className="space-y-3">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <div className="text-xs text-slate-500 mb-1">Max Size</div>
                      <div className="font-mono text-white">
