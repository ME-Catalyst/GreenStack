...
const KeyboardShortcutsHelp = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white dark:bg-surface rounded-lg shadow-2xl max-w-2xl w-full mx-4 max-h-[80vh] overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-border">
          <div className="flex items-center gap-2">
            <Keyboard className="w-5 h-5 text-primary dark:text-primary" />
              ...
              <div className="space-y-2">
                {shortcuts.map((shortcut, index) => (
                  ...
                  >
                    ...
                    <kbd className="px-3 py-1.5 text-sm font-mono bg-muted border border-border rounded shadow-sm text-foreground">
        ...
        <div className="px-6 py-4 border-t border-border bg-surface/50">
          <p className="text-sm text-muted-foreground text-center">
            Press <kbd className="px-2 py-1 text-xs font-mono bg-secondary border border-border rounded">?</kbd> to show this help
          </p>
        </div>
      </div>
    </div>
